                            ...
                            <form action="#" class="form mb-15" method="post" id="kt_contact_form">
                                ...
                                <div class="row g-9 mb-8">
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <select class="select_2 form-control form-select-solid"  data-allow-clear="true">
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <div class="position-relative d-flex align-items-center">
                                            ...
                                            <!--end::Icon-->
                                            <!--begin::Datepicker-->
                                            <input type="date" class="form-control form-control-solid ps-12 custom_date" placeholder="Select a date" name="due_date" />
                                            <!--end::Datepicker-->
                                        </div>
                                        <!--end::Input-->
                                    </div>
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-md-6 fv-row">
                                        <label class="required fs-6 fw-bold mb-2">Datetime</label>
                                        <!--begin::Input-->
                                        <div class="position-relative d-flex align-items-center">
                                            <!--begin::Icon-->
                                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                                            ...
                                            <!--end::Icon-->
                                            <!--begin::Datepicker-->
                                            <input type="date" class="form-control form-control-solid ps-12 custom_datetime" placeholder="Select a date" name="due_date" />
                                            <!--end::Datepicker-->
                                        </div>
                                        <!--end::Input-->
                                    </div>
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <div class="position-relative d-flex align-items-center">
                                            ...
                                            <!--end::Icon-->
                                            <!--begin::Datepicker-->
                                            <input type="date" class="form-control form-control-solid ps-12 custom_date_range" placeholder="Select a date" name="due_date" />
                                            <!--end::Datepicker-->
                                        </div>
                                        <!--end::Input-->
                                    </div>
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <div class="position-relative d-flex align-items-center">
                                            ...
                                            <!--end::Icon-->
                                            <!--begin::Datepicker-->
                                            <input type="date" class="form-control form-control-solid ps-12 custom_time" placeholder="Select a Time" name="time" />
                                            <!--end::Datepicker-->
                                        </div>
                                        <!--end::Input-->
                                    </div>
                                ...
                                <div class="d-flex flex-column mb-8 fv-row">
                                    ...
                                    <select class="form-control form-control-solid select_tags" multiple="multiple">
                                ...
                                <div class="d-flex flex-column mb-5 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Select-->
                                    <select name="country"  data-placeholder="Select a Country..." class="select_2 form-control form-select-solid">
